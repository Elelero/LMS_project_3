				                ...
				                <div class="table-responsive">
				                  <table id="boardListTable" class="table">
				                    	...
				                    	<tbody>
					                      <tr>
					                        <td class="text-left">
			                        			<h5 class="mt-3 ml-5">${fn: replace(board.boardContent, replaceChar, "</br>") }</h5>
												<div class="mt-5 mb-3 ml-5 d-flex" style="width:300px; height:200px;">
													<c:forEach var="file" items="${board.bfileList}">
														<img src='<c:url value="/board/file/${file.fileId}"/>' class="img-thumbnail mr-3" style="width:100%;">
													</c:forEach>						
												</div>
					                        </td>
					                      </tr>
